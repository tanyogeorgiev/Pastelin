...
## Installation
Download [.vsix file](https://github.com/tanyogeorgiev/Pastelin/releases/download/1.0.1/pastelin-1.0.1.vsix), open the command palette and select Extensions: Install from VSIX...
